...
| `FEATURE_RERANK_TIMEOUT_SECONDS` | `60` | Timeout for each feature-assessment batch. |
| `FEATURE_RERANK_BATCH_SIZE` / `FEATURE_RERANK_MAX_PARALLEL_BATCHES` | `20` / `4` | Compact candidate assessments per request and maximum concurrent requests. |
