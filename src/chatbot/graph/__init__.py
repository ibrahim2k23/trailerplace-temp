        ...
        return _active_turn_reconciler_llm().invoke(
            [
                SystemMessage(content=(
                    ...
                    "2. Never overwrite an existing slot with an answer to another slot. Merge valid extractor "
                    "updates only when explicitly supported by the latest message.\n"
                    "3. search_now_requested and skip_remaining_questions are semantic intent decisions. Set them "
                    "only when the user's message actually expresses those intents.\n"
                    "4. Prefer the best-supported interpretation across the three proposals; confidence reflects "
                    ...
                    "5. A counter-question is unresolved, not no preference. When counter_question_topic is not "
                    ...
                    "6. Explicit requests to stop/skip questions or show results are supported search controls, "
                    ...
                    f"asks the business to perform an unsupported real-world action: for example {escalation_actions()}. Such a request "
            ...
            [
                SystemMessage(
                    content=(
                        ...
                        "customer. The user must request "
